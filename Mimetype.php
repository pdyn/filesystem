...
/**
 * The mimetype list in this class is generated from the /etc/mime.types file in Ubuntu, provided by the "mime-support" package.
 * The source "mime.types" file is listed as in the public domain (https://launchpad.net/ubuntu/utopic/+source/mime-support/+copyright)
 * and this file is released to the public domain as well.
 */
...
class Mimetype {
	...
	public static function ext2mime($ext) {
		...
		return (isset($ext2mime[$ext])) ? $ext2mime[$ext] : 'application/unknown';
	}
